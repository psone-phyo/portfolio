...
let languages = ref([
    ...
    {lang: Css, color: 'border-sky-500'},
    {lang: Javascript, color: 'border-yellow-500'},
    {lang: Bootstrap, color: 'border-purple-500'},
    {lang: Tailwind, color: 'border-sky-300'},
    {lang: PHP, color: 'border-blue-800'},
